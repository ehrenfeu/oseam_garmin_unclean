...
"${WORKDIR}/mkmymap.sh" oseam_ng_european_arctic "left=-45 right=45 bottom=59 top=82"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_russian_arctic "left=45 right=180 bottom=66 top=82"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
...
"${WORKDIR}/mkmymap.sh" oseam_ng_nw_atlantic "left=-82 right=-45 bottom=31 top=65"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_ne_atlantic "left=-45 right=0 bottom=31 top=50"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
...
"${WORKDIR}/mkmymap.sh" oseam_ng_equatorial_atlantic "left=-53 right=-14 bottom=-07 top=31"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
...
"${WORKDIR}/mkmymap.sh" oseam_ng_south_atlantic "left=-40 right=20 bottom=-68 top=07"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_nw_pacific "left=117 right=180 bottom=30 top=66"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_ne_pacific "left=-180 right=-120 bottom=47 top=66"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_us_west_coast "left=-180 right=112 bottom=30 top=49"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_north_equatorial_pacific "left=130 right=-95 bottom=0 top=30"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
...
"${WORKDIR}/mkmymap.sh" oseam_ng_southpacific "left=163 right=-76 bottom=-70 top=10"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_tasman_sea "left=141 right=-177 bottom=-70 top=0"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
"${WORKDIR}/mkmymap.sh" oseam_ng_south_australia "left=116 right=141 bottom=-65 top=-31"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
...
"${WORKDIR}/mkmymap.sh" oseam_ng_us_great_lakes "left=-93 right=-76 bottom=41 top=51"|tee -a "${LOGFILE}" || logerr "mkmymap 1 failed"
